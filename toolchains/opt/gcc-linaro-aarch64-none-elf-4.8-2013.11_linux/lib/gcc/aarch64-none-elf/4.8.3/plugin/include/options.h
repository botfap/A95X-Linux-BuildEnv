...
enum opt_code
{
  ...
  OPT_march_ = 1037,                         /* -march= */
  OPT_mbig_endian = 1038,                    /* -mbig-endian */
  OPT_mcmodel_ = 1039,                       /* -mcmodel= */
  OPT_mcpu_ = 1040,                          /* -mcpu= */
  OPT_mgeneral_regs_only = 1041,             /* -mgeneral-regs-only */
  OPT_mlittle_endian = 1042,                 /* -mlittle-endian */
  OPT_momit_leaf_frame_pointer = 1043,       /* -momit-leaf-frame-pointer */
  OPT_mstrict_align = 1044,                  /* -mstrict-align */
  OPT_mtls_dialect_ = 1045,                  /* -mtls-dialect= */
  OPT_mtune_ = 1046,                         /* -mtune= */
  OPT_n = 1047,                              /* -n */
  OPT_no_canonical_prefixes = 1048,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1049,              /* -no-integrated-cpp */
  OPT_nocpp = 1050,                          /* -nocpp */
  OPT_nodefaultlibs = 1051,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1052,                   /* -nostartfiles */
  OPT_nostdinc = 1053,                       /* -nostdinc */
  OPT_nostdinc__ = 1054,                     /* -nostdinc++ */
  OPT_nostdlib = 1055,                       /* -nostdlib */
  OPT_o = 1056,                              /* -o */
  OPT_p = 1057,                              /* -p */
  OPT_pass_exit_codes = 1058,                /* -pass-exit-codes */
  /* OPT_pedantic = 1059, */                 /* -pedantic */
  OPT_pedantic_errors = 1060,                /* -pedantic-errors */
  OPT_pg = 1061,                             /* -pg */
  OPT_pie = 1062,                            /* -pie */
  OPT_pipe = 1063,                           /* -pipe */
  OPT_print_file_name_ = 1064,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1065,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1066,          /* -print-multi-directory */
  OPT_print_multi_lib = 1067,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1068,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1069,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1070,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1071,               /* -print-prog-name= */
  OPT_print_search_dirs = 1072,              /* -print-search-dirs */
  OPT_print_sysroot = 1073,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1074,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1075,                          /* -quiet */
  OPT_r = 1076,                              /* -r */
  OPT_remap = 1077,                          /* -remap */
  OPT_s = 1078,                              /* -s */
  OPT_s_bc_abi = 1079,                       /* -s-bc-abi */
  OPT_save_temps = 1080,                     /* -save-temps */
  OPT_save_temps_ = 1081,                    /* -save-temps= */
  OPT_shared = 1082,                         /* -shared */
  OPT_shared_libgcc = 1083,                  /* -shared-libgcc */
  /* OPT_specs = 1084, */                    /* -specs */
  OPT_specs_ = 1085,                         /* -specs= */
  OPT_static = 1086,                         /* -static */
  OPT_static_libasan = 1087,                 /* -static-libasan */
  OPT_static_libgcc = 1088,                  /* -static-libgcc */
  OPT_static_libgcj = 1089,                  /* -static-libgcj */
  OPT_static_libgfortran = 1090,             /* -static-libgfortran */
  OPT_static_libgo = 1091,                   /* -static-libgo */
  OPT_static_libstdc__ = 1092,               /* -static-libstdc++ */
  OPT_static_libtsan = 1093,                 /* -static-libtsan */
  /* OPT_std_c__03 = 1094, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1095, */                /* -std=c++0x */
  OPT_std_c__11 = 1096,                      /* -std=c++11 */
  OPT_std_c__1y = 1097,                      /* -std=c++1y */
  OPT_std_c__98 = 1098,                      /* -std=c++98 */
  OPT_std_c11 = 1099,                        /* -std=c11 */
  /* OPT_std_c1x = 1100, */                  /* -std=c1x */
  /* OPT_std_c89 = 1101, */                  /* -std=c89 */
  OPT_std_c90 = 1102,                        /* -std=c90 */
  OPT_std_c99 = 1103,                        /* -std=c99 */
  /* OPT_std_c9x = 1104, */                  /* -std=c9x */
  OPT_std_f2003 = 1105,                      /* -std=f2003 */
  OPT_std_f2008 = 1106,                      /* -std=f2008 */
  OPT_std_f2008ts = 1107,                    /* -std=f2008ts */
  OPT_std_f95 = 1108,                        /* -std=f95 */
  OPT_std_gnu = 1109,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1110, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1111, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1112,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1113,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1114,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1115,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1116, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1117, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1118,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1119,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1120, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1121, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1122,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1123, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1124, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1125, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1126,                     /* -std=legacy */
  OPT_symbolic = 1127,                       /* -symbolic */
  OPT_t = 1128,                              /* -t */
  OPT_time = 1129,                           /* -time */
  OPT_time_ = 1130,                          /* -time= */
  OPT_traditional = 1131,                    /* -traditional */
  OPT_traditional_cpp = 1132,                /* -traditional-cpp */
  OPT_trigraphs = 1133,                      /* -trigraphs */
  OPT_u = 1134,                              /* -u */
  OPT_undef = 1135,                          /* -undef */
  OPT_v = 1136,                              /* -v */
  OPT_version = 1137,                        /* -version */
  OPT_w = 1138,                              /* -w */
  OPT_wrapper = 1139,                        /* -wrapper */
  OPT_x = 1140,                              /* -x */
  OPT_z = 1141,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
