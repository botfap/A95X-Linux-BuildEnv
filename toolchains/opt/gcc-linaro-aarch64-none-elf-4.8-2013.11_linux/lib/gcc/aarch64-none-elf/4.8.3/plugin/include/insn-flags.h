...
#define HAVE_aarch64_frecpesf (TARGET_FLOAT)
#define HAVE_aarch64_frecpxsf (TARGET_FLOAT)
#define HAVE_aarch64_frecpedf (TARGET_FLOAT)
#define HAVE_aarch64_frecpxdf (TARGET_FLOAT)
#define HAVE_aarch64_frecpssf (TARGET_FLOAT)
#define HAVE_aarch64_frecpsdf (TARGET_FLOAT)
...
#define HAVE_reduc_umax_v2di (TARGET_SIMD)
#define HAVE_reduc_umin_v2di (TARGET_SIMD)
#define HAVE_reduc_smax_v2di (TARGET_SIMD)
#define HAVE_reduc_smin_v2di (TARGET_SIMD)
...
#define HAVE_reduc_smax_nan_v2sf (TARGET_SIMD)
#define HAVE_reduc_smin_nan_v2sf (TARGET_SIMD)
#define HAVE_reduc_smax_v2sf (TARGET_SIMD)
#define HAVE_reduc_smin_v2sf (TARGET_SIMD)
#define HAVE_reduc_smax_nan_v2df (TARGET_SIMD)
#define HAVE_reduc_smin_nan_v2df (TARGET_SIMD)
#define HAVE_reduc_smax_v2df (TARGET_SIMD)
#define HAVE_reduc_smin_v2df (TARGET_SIMD)
#define HAVE_reduc_smax_nan_v4sf (TARGET_SIMD)
#define HAVE_reduc_smin_nan_v4sf (TARGET_SIMD)
...
extern rtx        gen_reduc_umax_v2di                    (rtx, rtx);
extern rtx        gen_reduc_umin_v2di                    (rtx, rtx);
extern rtx        gen_reduc_smax_v2di                    (rtx, rtx);
extern rtx        gen_reduc_smin_v2di                    (rtx, rtx);
