...
#define ggc_alloc_arc_frame_info() ((struct arc_frame_info *)(ggc_internal_alloc_stat (sizeof (struct arc_frame_info) MEM_STAT_INFO)))
#define ggc_alloc_cleared_arc_frame_info() ((struct arc_frame_info *)(ggc_internal_cleared_alloc_stat (sizeof (struct arc_frame_info) MEM_STAT_INFO)))
#define ggc_alloc_vec_arc_frame_info(n) ((struct arc_frame_info *)(ggc_internal_vec_alloc_stat (sizeof (struct arc_frame_info), n MEM_STAT_INFO)))
#define ggc_alloc_cleared_vec_arc_frame_info(n) ((struct arc_frame_info *)(ggc_internal_cleared_vec_alloc_stat (sizeof (struct arc_frame_info), n MEM_STAT_INFO)))
#define ggc_alloc_arc_ccfsm() ((struct arc_ccfsm *)(ggc_internal_alloc_stat (sizeof (struct arc_ccfsm) MEM_STAT_INFO)))
#define ggc_alloc_cleared_arc_ccfsm() ((struct arc_ccfsm *)(ggc_internal_cleared_alloc_stat (sizeof (struct arc_ccfsm) MEM_STAT_INFO)))
#define ggc_alloc_vec_arc_ccfsm(n) ((struct arc_ccfsm *)(ggc_internal_vec_alloc_stat (sizeof (struct arc_ccfsm), n MEM_STAT_INFO)))
#define ggc_alloc_cleared_vec_arc_ccfsm(n) ((struct arc_ccfsm *)(ggc_internal_cleared_vec_alloc_stat (sizeof (struct arc_ccfsm), n MEM_STAT_INFO)))
