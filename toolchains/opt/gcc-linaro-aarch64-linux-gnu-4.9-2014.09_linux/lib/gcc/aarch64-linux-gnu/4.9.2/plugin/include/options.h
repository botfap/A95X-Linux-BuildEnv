...
enum opt_code
{
  ...
  OPT_mbionic = 1069,                        /* -mbionic */
  OPT_mcmodel_ = 1070,                       /* -mcmodel= */
  OPT_mcpu_ = 1071,                          /* -mcpu= */
  OPT_mgeneral_regs_only = 1072,             /* -mgeneral-regs-only */
  OPT_mglibc = 1073,                         /* -mglibc */
  OPT_mlittle_endian = 1074,                 /* -mlittle-endian */
  OPT_mlra = 1075,                           /* -mlra */
  OPT_momit_leaf_frame_pointer = 1076,       /* -momit-leaf-frame-pointer */
  OPT_mstrict_align = 1077,                  /* -mstrict-align */
  OPT_mtls_dialect_ = 1078,                  /* -mtls-dialect= */
  OPT_mtune_ = 1079,                         /* -mtune= */
  OPT_muclibc = 1080,                        /* -muclibc */
  OPT_n = 1081,                              /* -n */
  ...
  OPT_static_liblsan = 1130,                 /* -static-liblsan */
  OPT_static_libstdc__ = 1131,               /* -static-libstdc++ */
  OPT_static_libtsan = 1132,                 /* -static-libtsan */
  OPT_static_libubsan = 1133,                /* -static-libubsan */
  /* OPT_std_c__03 = 1134, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1135, */                /* -std=c++0x */
  OPT_std_c__11 = 1136,                      /* -std=c++11 */
  /* OPT_std_c__14 = 1137, */                /* -std=c++14 */
  ...
  /* OPT_std_gnu__14 = 1154, */              /* -std=gnu++14 */
  ...
  OPT_time = 1171,                           /* -time */
  OPT_time_ = 1172,                          /* -time= */
  OPT_traditional = 1173,                    /* -traditional */
  OPT_traditional_cpp = 1174,                /* -traditional-cpp */
  OPT_trigraphs = 1175,                      /* -trigraphs */
  OPT_u = 1176,                              /* -u */
  OPT_undef = 1177,                          /* -undef */
  OPT_v = 1178,                              /* -v */
  OPT_version = 1179,                        /* -version */
  OPT_w = 1180,                              /* -w */
  OPT_wrapper = 1181,                        /* -wrapper */
  OPT_x = 1182,                              /* -x */
  OPT_z = 1183,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
