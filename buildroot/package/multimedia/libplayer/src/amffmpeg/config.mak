...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-yasm --enable-debug --disable-ffplay --disable-ffmpeg --cross-prefix=arm-none-linux-gnueabi- --enable-cross-compile --target-os=linux --arch=arm --disable-librtmp --disable-static --enable-shared --disable-ffplay --disable-ffserver --disable-doc
prefix=$(LIBPLAYER_STAGING_DIR)/usr
LIBDIR=${prefix}/lib
SHLIBDIR=${prefix}/lib/libplayer
INCDIR=${prefix}/include
BINDIR=${prefix}/bin
DATADIR=${prefix}/share/ffmpeg
MANDIR=${prefix}/share/man
SRC_PATH=$(shell pwd)
SRC_PATH_BARE=$(shell pwd)
...
EXTRALIBS=-ldl -lm -pthread -L$(SHLIBDIR) -lamavutils 
INSTALL=install
LIBTARGET=
