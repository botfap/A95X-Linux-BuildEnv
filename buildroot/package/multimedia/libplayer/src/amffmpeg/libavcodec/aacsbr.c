...
/*	CHANGED by gp, if sample_rate is not eq to ext_sample_rate, we use sample_rate*/
    if(sbr->sample_rate != ac->m4ac.ext_sample_rate)
        ac->m4ac.ext_sample_rate = sbr->sample_rate;
